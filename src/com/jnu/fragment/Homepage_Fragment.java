...
//	private Button button_compare,button_warning;
	...
	private OnTouchListener list_listenner;
	private homepage_listview_adapter adapter;
	
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		container=(ViewGroup) inflater.inflate(R.layout.homepage_layout, null);
		viewGroup=container;
		initview();
		initlistener();
		setadapter();
...
//		button_warning=(Button) viewGroup.findViewById(R.id.button_warning);
		compare=(ImageView) viewGroup.findViewById(R.id.filter);
	...
	private void initlistener(){
		...
		list_listenner=new OnTouchListener() {
			@Override
